...
(function()
{
	...
	Menus.prototype.init = function()
	{
		...
		editorUi.actions.addAction('seafDownload', function()
		{
			// Placeholder for future SEAF Download logic
		});

		editorUi.actions.addAction('seafCreateP41', function()
		{
			// Placeholder for future SEAF Create P41 logic
		});

		editorUi.actions.addAction('seafUpload', function()
		{
		...
		{
			editorUi.menus.addMenuItem(menu, 'seafDownload', parent, null, null, 'Download');
			editorUi.menus.addMenuItem(menu, 'seafCreateP41', parent, null, null, 'Create P41');
			editorUi.menus.addMenuItem(menu, 'seafUpload', parent, null, null, 'Upload');
		})));
